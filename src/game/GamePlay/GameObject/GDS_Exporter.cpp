...
{
		1.0,		0.0,		1.0,		0.0,		300.0,		200.0,		10.0,		10.0,		1.0,
		2.0,		300.0,		2.0,		0.0,		300.0,		8.0,		15.0,		15.0,		1.0,
		3.0,		700.0,		1.0,		0.0,		1200.0,		400.0,		20.0,		20.0,		1.0,
		4.0,		1200.0,		2.0,		0.0,		1200.0,		20.0,		25.0,		25.0,		1.0,
		5.0,		1800.0,		3.0,		0.0,		2500.0,		800.0,		30.0,		30.0,		1.0,
...
const float GDS_Exporter::cavalry_des[28] = 
{
		...
		8000.0,		300.0,		1700.0,		80.0,		3.5,		1.0,		4.8,
		10000.0,		500.0,		1700.0,		90.0,		3.5,		1.0,		5.2,
		13000.0,		1000.0,		1700.0,		100.0,		3.5,		1.0,		5.5,
...
const float GDS_Exporter::mule_des[28] = 
{
		...
		8000.0,		300.0,		800.0,		70.0,		2.6,		1.0,		4.3,
		10000.0,		600.0,		800.0,		80.0,		2.6,		1.0,		4.8,
		12000.0,		1000.0,		800.0,		100.0,		2.6,		1.0,		5.2,
...
const float GDS_Exporter::machete_des[24] = 
{
		...
		6000.0,		300.0,		0.0,		12.0,		50.0,		1.2,
		7000.0,		500.0,		0.0,		15.0,		55.0,		1.2,
		9000.0,		1000.0,		0.0,		20.0,		60.0,		1.2,
...
const float GDS_Exporter::gun_des[36] = 
{
		...
		11.0,		0.8,		2.0,		500.0,		100.0,		0.4,
		11.0,		0.8,		3.0,		650.0,		200.0,		0.3,
		12.0,		0.7,		4.0,		750.0,		400.0,		0.3,
		12.0,		0.6,		5.0,		800.0,		800.0,		0.2,
		13.0,		0.5,		6.0,		900.0,		1000.0,		0.2,
...
const float GDS_Exporter::enemy_des[35] = 
{
		...
		4.0,		1.0,		1.3,		4.0,		4.0,		120.0,		5.0,
		5.0,		1.0,		1.5,		12.0,		5.0,		150.0,		5.5,
...
{
		100.0,		2.0,		4.0,		15.0,		20.0,		0.0,		0.0,		0.0,		1.0,		3.0,		70.0,		20.0,		10.0,		0.0,		0.0,
		300.0,		3.0,		4.0,		20.0,		25.0,		0.0,		0.0,		1.0,		2.0,		2.0,		70.0,		20.0,		10.0,		0.0,		0.0,
		500.0,		2.0,		3.0,		25.0,		30.0,		0.0,		0.0,		2.0,		3.0,		2.0,		50.0,		40.0,		10.0,		0.0,		0.0,
		700.0,		2.0,		5.0,		30.0,		35.0,		0.0,		0.0,		2.0,		5.0,		2.0,		20.0,		50.0,		30.0,		0.0,		0.0,
		1000.0,		3.0,		7.0,		35.0,		45.0,		0.0,		0.0,		3.0,		5.0,		2.0,		0.0,		65.0,		35.0,		0.0,		0.0,
		1200.0,		4.0,		7.0,		40.0,		50.0,		0.0,		0.0,		4.0,		6.0,		1.0,		0.0,		20.0,		60.0,		20.0,		0.0,
		1500.0,		3.0,		5.0,		45.0,		55.0,		0.0,		0.0,		2.0,		5.0,		1.0,		0.0,		15.0,		60.0,		25.0,		0.0,
		1800.0,		4.0,		6.0,		50.0,		60.0,		0.0,		0.0,		3.0,		5.0,		1.0,		0.0,		10.0,		50.0,		40.0,		0.0,
		2200.0,		7.0,		10.0,		55.0,		65.0,		0.0,		0.0,		4.0,		7.0,		1.0,		0.0,		0.0,		50.0,		40.0,		10.0,
		2500.0,		4.0,		7.0,		60.0,		70.0,		0.0,		0.0,		3.0,		6.0,		1.0,		0.0,		0.0,		40.0,		40.0,		20.0,
		2800.0,		4.0,		7.0,		65.0,		75.0,		0.0,		0.0,		4.0,		6.0,		1.0,		0.0,		0.0,		35.0,		40.0,		25.0,
		3200.0,		5.0,		8.0,		70.0,		85.0,		0.0,		0.0,		4.0,		8.0,		1.0,		0.0,		0.0,		20.0,		50.0,		30.0,
		3500.0,		5.0,		8.0,		75.0,		90.0,		0.0,		1.0,		4.0,		6.0,		1.0,		0.0,		0.0,		25.0,		40.0,		35.0,
		4000.0,		6.0,		8.0,		80.0,		95.0,		0.0,		1.0,		6.0,		9.0,		1.0,		0.0,		0.0,		30.0,		30.0,		40.0,
